/**
 * ElectricFieldOfDreamsNamespace.ts
 *
...
const ElectricFieldOfDreamsNamespace = new Namespace("electric-field-of-dreams");

export default ElectricFieldOfDreamsNamespace;
