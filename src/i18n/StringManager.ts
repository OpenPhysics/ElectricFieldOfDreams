...
// satisfies errors immediately if any locale file is missing keys the others have.
// All three locales feed getNestedStringProperties below, so all three are checked.
