/**
 * ElectricFieldOfDreamsButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = ElectricFieldOfDreamsColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link ElectricFieldOfDreamsColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: ElectricFieldOfDreamsColors.controlSurfaceColorProperty,
  listFill: ElectricFieldOfDreamsColors.controlSurfaceColorProperty,
  buttonStroke: ElectricFieldOfDreamsColors.panelBorderColorProperty,
  listStroke: ElectricFieldOfDreamsColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: ElectricFieldOfDreamsColors.textColorProperty },
  },
